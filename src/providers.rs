...
pub fn default_providers() -> Vec<Arc<dyn TranslationProvider + Send + Sync>> {
    let providers: Vec<Arc<dyn TranslationProvider + Send + Sync>> = vec![
        ...
        android!("", source => "device/generic/vulkan-cereal",              "third-party/angle/src/android_system_settings/res"),
        android!("", source => "device/google/atv",                         "FrameworkPackageStubs/res"),
        android!("", source => "device/google/atv",                         "libraries/BluetoothServices/res"),
        android!("", source => "device/google/atv",                         "overlay/TvFrameworkOverlay/res"),
        android!("", source => "device/google/gs101",                       "overlay-vendor/vendor/google/apps/SetupWizard/res"),
        ...
        android!("", source => "packages/modules/Connectivity",             "nearby/halfsheet/res"),
        ...
        android!("", source => "packages/services/Car",                     "car_product/car_ui_portrait/rro/CarUiPortraitLauncherRRO/res"),
